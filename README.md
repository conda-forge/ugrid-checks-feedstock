...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ugrid-checks-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15508&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ugrid-checks-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ugrid-checks` can be installed with:

```
conda install ugrid-checks
```

It is possible to list all of the versions of `ugrid-checks` available on your platform with:
